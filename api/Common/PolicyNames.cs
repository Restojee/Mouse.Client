...
public static class PolicyNames
{
    ...
    public const string LevelsWrite = nameof(LevelsWrite);
    ...
    public const string TagsWrite = nameof(TagsWrite);
    ...
    public const string TipsWrite = nameof(TipsWrite);
    ...
    public const string CommentsWrite = nameof(CommentsWrite);
    ...
    public const string MessagesWrite = nameof(MessagesWrite);
    ...
    public const string InvitesWrite = nameof(InvitesWrite);
    ...
    public const string RolesAll = nameof(RolesAll);

    public const string UserSessionsRead = nameof(UserSessionsRead);
    public const string UserSessionsWrite = nameof(UserSessionsWrite);
...
public static class PolicyToPermission
{
    public static string GetRequiredPermission(string policyName)
    {
        return policyName switch
        {
            ...
            nameof(PolicyNames.LevelsWrite) => Permissions.LevelsWrite,
            ...
            nameof(PolicyNames.TagsWrite) => Permissions.TagsWrite,
            ...
            nameof(PolicyNames.TipsWrite) => Permissions.TipsWrite,
            ...
            nameof(PolicyNames.CommentsWrite) => Permissions.CommentsWrite,
            ...
            nameof(PolicyNames.MessagesWrite) => Permissions.MessagesWrite,
            ...
            nameof(PolicyNames.InvitesWrite) => Permissions.InvitesWrite,
            ...
            nameof(PolicyNames.UsersWrite) => Permissions.UsersWrite,
            ...
            nameof(PolicyNames.RolesAll) => Permissions.RolesAll,
            nameof(PolicyNames.UserSessionsRead) => Permissions.UserSessionsRead,
            nameof(PolicyNames.UserSessionsWrite) => Permissions.UserSessionsWrite,
