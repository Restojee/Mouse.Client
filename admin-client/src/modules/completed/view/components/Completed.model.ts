...
class CompletedGridModel extends ViewModel<CompletedProps> {
  ...
  public get getToolbarItems() {
    return getCompletedToolbarItems({
      ...
      onSearch: this.handleFilterSearchTextChange,
      selectedRows: this.selectedRows,
      onCreate: this.handleCreateCompleted.bind(this),
      onDelete: this.handleDelete.bind(this),
      formState: this.createForm,
      onFormUserChange: this.handleFormUserChange,
      onFormLevelChange: this.handleFormLevelChange,
      onFormDescriptionChange: this.handleFormDescriptionChange,
      onFormImageChange: this.handleFormImageChange,
