...
export const mapsApi = {
  getMaps: async (params: apiTypes.GetMapsApiArg) => {
    const query = queryString.stringify(capitalizeKeys(params));

    const res = await api.get<apiTypes.GetMapsApiArg, AxiosResponse<apiTypes.GetMapsApiResponse>>(
      `/levels/collect?${query}`,
    );
    return res.data;
  },
  ...
  createMap: async (body: apiTypes.CreateMapRequest) => {
    const res = await api.post<apiTypes.CreateMapRequest, AxiosResponse<apiTypes.CreateMapApiResponse>>(
      "/levels/create",
      body,
    );
    return res.data;
  ...
  deleteMap: async (params: apiTypes.DeleteMapApiArg) => {
    const res = await api.delete<apiTypes.DeleteMapApiArg, AxiosResponse<apiTypes.DeleteMapApiResponse>>(
      `/levels/remove/${params.levelId}`,
    );
    return res.data;
  },
  setMapsTag: async (body: apiTypes.SetMapsTagApiArg) => {
    const res = await api.put<apiTypes.SetMapsTagApiArg, AxiosResponse<apiTypes.SetMapsTagApiResponse>>(
      "/levels/set-tags",
      body,
    );
    return res.data;
  ...
  removeFavorite: async (params: apiTypes.RemoveFavoriteMapApiArg) => {
    const res = await api.delete<
      apiTypes.RemoveFavoriteMapApiArg,
      AxiosResponse<apiTypes.RemoveFavoriteMapApiResponse>
